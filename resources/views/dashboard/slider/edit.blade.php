...
@section('content')
<form method="post" action="{{ url('dashboard/slider/'.$slide->id) }}" enctype="multipart/form-data">
	{{ csrf_field() }}
	{{ method_field('PUT') }}
	<div class="row">
		...
		<div class="col-md-12">
		        ...
		        <div class="fileinput fileinput-new" data-provides="fileinput" style="display:block">
		          <div class="col-sm-12">
		            <div class="fileinput-new thumbnail col-sm-12">
		                <img data-src="" src="{{ url('/images/normal/'.$slide->image) }}" class="img-responsive">
		            </div>
		  ...
		  <div class="col-md-6">
		    ...
		    <input value="{{ $slide->label }}" name="label" class="input__field input__field--hoshi" type="text" id="label">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ $slide->link }}" name="link" class="input__field input__field--hoshi" type="text" id="link">
	...
	<div class="col-md-12 m-t-10">
	  	<input type="submit" class="btn btn-dark btn-block btn-embossed" value="Update Slide">
	</div>
