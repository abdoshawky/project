...
<form method="post" action="{{ url('dashboard/users') }}" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-md-12">
		  ...
		  <div class="col-md-6">
		    ...
		    <input value="{{ old('name') }}" name="name" class="input__field input__field--hoshi" type="text" id="name">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('email') }}" name="email" class="input__field input__field--hoshi" type="text" id="email">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('phone') }}" name="phone" class="input__field input__field--hoshi" type="text" id="phone">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('address') }}" name="address" class="input__field input__field--hoshi" type="text" id="address">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('facebook') }}" name="facebook" class="input__field input__field--hoshi" type="text" id="facebook">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('twitter') }}" name="twitter" class="input__field input__field--hoshi" type="text" id="twitter">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('instagram') }}" name="instagram" class="input__field input__field--hoshi" type="text" id="instagram">
		  ...
		  <div class="col-md-6">
		    <span class="input input--hoshi">
		    <input value="{{ old('google') }}" name="google" class="input__field input__field--hoshi" type="text" id="google">
	...
	<div class="col-md-12 m-t-10">
	  	<input type="submit" class="btn btn-dark btn-block btn-embossed" value="Add User">
	</div>
